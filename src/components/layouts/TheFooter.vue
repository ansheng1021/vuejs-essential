...
<script>
    ...
    export default {
        ...
        data() {
            return {
                description: '30秒懂车是中国汽车视频第一门户',
                contacts: [
                    {
                        icon: 'envelope',
                        title: '反馈问题',
                        link: 'mailto:1076597015@qq.com'
                    },
                    {
                        icon: 'weibo',
                        title: '站长微博',
                        link: 'https://www.lzjrys.store/'
                    },
                    {
                        icon: 'weixin',
                        title: '加我微信',
        ...
        <span style="font-size:0.9em">Designed by
          ...
          <a href="https://github.com/summerblue"target="_blank"style="color:inherit">Ansheng</a>
        </span>
      `,
                sponsor: {
                    title: '赞助商',
